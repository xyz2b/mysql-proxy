...
public class ErrorCode {
    ...
    public static final int ERR_FINISH_CONNECT                         = 3003;
    ...
    public static final int ERR_EXCEPTION_CAUGHT                       = 3010;
    public static final int ERR_SINGLE_EXECUTE_NODES                   = 3011;
    public static final int NO_TRANSACTION_IN_MULTI_NODES              = 3012;
    ...
    public static final int ER_MULTI_QUERY_TIMEOUT                     = 1495;
    public static final int ER_MULTI_EXEC_ERROR                        = 1496;
}
